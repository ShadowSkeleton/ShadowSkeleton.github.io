...
import { Mail, Linkedin, Github, ArrowUpRight, ArrowUp } from "./Icons";
...
export default function Contact() {
    ...
    return <section id="contact" className="section contact-section">
        <div className="shell">
            <div className="surface-shell"><div className="contact-panel surface-body"><p className="eyebrow">{t("Let’s connect")}</p><h2>{t("Get In Touch")}<span>.</span></h2><p>{t("Have a software role, a project, or an idea to discuss? I’d be glad to hear from you.")}</p>
