...
import { BadgeCheck, ArrowUpRight } from "./Icons";
...
export default function Certifications() {
    ...
    return <section id="certifications" className="section">
        <div className="shell">
            <div className="section-heading"><div><p className="eyebrow">{t("Continued learning")}</p><h2>{t("Certifications")}</h2></div></div>
            <div className="cert-grid">{certs.map(cert => <article className="cert-card surface-shell" key={cert.title}><div className="cert-body surface-body">
